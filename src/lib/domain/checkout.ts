...
export const sandboxAutoConfirmSchema = sandboxAutoQuoteSchema.extend({ attemptId: z.string().uuid(), confirmed: z.literal(true), confirmationText: z.literal('Confirm Test Purchase') }).strict();
