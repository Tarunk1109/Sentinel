...
import type { ImageInspector, ProductReasoner } from './services/live-contracts';
...
export function createReasoner(): ProductReasoner & ImageInspector {
  ...
  return { understand: disabled, evaluate: disabled, analyzeInspectionImage: disabled };
}
