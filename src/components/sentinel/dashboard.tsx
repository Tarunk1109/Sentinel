  ...
  return <div className={`app-shell view-${view}`} data-motion={motionEnabled ? "on" : "off"}>
    ...
    <aside className="workspace-sidebar" aria-label="Workspace navigation">
      ...
      <div className="sidebar-bottom">
        ...
        <div className="sidebar-edition">SENTINEL <span>COMMERCE INTELLIGENCE</span></div>
      </div>
    </aside>
    ...
    <main id="main" tabIndex={-1} className="main-content"><div className="studio-wayfinding"><span><span className="workspace-indicator" />{view === "request" ? "YOUR COMMERCE WORKSPACE" : view === "inspect" ? "VISUAL INSPECTION" : "PROJECT PLANNING"}</span><span className="studio-edition">Canada <span>·</span> CAD</span></div>
      ...
      {view !== "build" && hasWorkspace && <>
        <div className="workspace-toolbar"><div><span className="workspace-title">PRODUCT SHORTLIST</span><span className="workspace-caption">Compare the details that matter.</span></div><Button variant="ghost" size="sm" onClick={newMission}><Plus size={14} />New {modeNoun[view]}</Button></div>
