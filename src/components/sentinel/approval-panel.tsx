  ...
  return <div className="space-y-5">
    <div className="grid gap-7 lg:grid-cols-[1.05fr_1fr]">
      ...
      <div className="border-t border-border pt-5 lg:border-l lg:border-t-0 lg:pl-7 lg:pt-0">
        ...
        {preview && <p className="mt-3 text-xs leading-relaxed text-muted-foreground">{preview.message}</p>}
        ...
        {sandbox && !orderStarted && <Button type="button" className="mt-3 w-full" disabled={!readyForConsent} onClick={() => setConsentOpen(true)}>Review Test Purchase</Button>}
      </div>
    </div>
