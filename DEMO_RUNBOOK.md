...
Show Request, Inspect, and Build in the sidebar. Explain: Request understands a need; Inspect diagnoses a photo; Build creates a bill of materials. In Inspect, show Take Photo and Upload Image, then use the prepared image and briefly show the evidence-based recommendation.

## 0:35–1:35 — Autopilot + Voice

Open Autopilot & Voice. Say or paste: “Keep Coke, Sprite and Fanta stocked every week and spend at most 70 Canadian dollars.” Review the structured weekly C$70 mandate, its three preferred items, and confirm activation. Press Run now and point out the factual policy events, remaining budget, and “No purchase executed.” Mention that persistence and scheduling are demo/runtime only.
